...
class EstatePropertyOfferFifteen(models.Model):
    _name = "estate.property.offer.fifteen"
    _description = "offer model for chapter fifteen"
    ...
    property_id = fields.Many2one(
        "estate.property.fifteen", string="Property")
    ...
    def create(self,vals):
        property = self.env["estate.property.fifteen"].browse(vals['property_id'])
        ...
        return super(EstatePropertyOfferFifteen,self).create(vals)
