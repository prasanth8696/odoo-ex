...
class EstatePropertyOfferFourteen(models.Model):
    _name = "estate.property.offer.fourteen"
    _description = "offer model for chapter fourteen"
    ...
    property_id = fields.Many2one(
        "estate.property.fourteen", string="Property")
    property_type_id = fields.Many2one("estate.property.type.fourteen",string = "property type")
    ...
    def create(self,vals):
        property = self.env["estate.property.fourteen"].browse(vals['property_id'])
        ...
        return super(EstatePropertyOfferFourteen,self).create(vals)
